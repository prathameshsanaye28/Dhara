import 'package:dhara_sih/screens/pdf_summarizer/summary_display.dart';
...
class SelectReportsScreen extends StatelessWidget {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: Colors.transparent,
          title: Text("Select Shift Logs", style: TextStyle(
                      fontSize: 20,
                ...
                child: Column(
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: CustomGreenButton(label: 'Submit'))
                  ],
                ),
              ),
            ),
