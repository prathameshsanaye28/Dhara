                                      ...
                                      ShaderMask(
                                        ...
                                        child: SfLinearGauge(
                                          axisTrackStyle: LinearAxisTrackStyle(
                                            ...
                                            color: Colors.grey
                                                .shade800, // Background for empty part
                                          ),
                                          barPointers: [
                                            LinearBarPointer(
                                              value: 32,
                                      ...
                                      Padding(
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  Text("Moderate Temperature: ", style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 14,
                                                    fontWeight: FontWeight.bold
                                                  ),),
                                                  Text("Monitor Conditions closely", style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 14,
                                                  ),),
                                                ],
                                      ...
                                      Column(
                                        children: [
                                          Row(
                                            ...
                                            children: [
                                              Text("Methane(CH4):",style: TextStyle(
                                                color: Colors.white,
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18
                                              ),),
                                          ...
                                          Row(
                                            mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                                            children: [
                                              Text("Carbon Dioxide(CO2):",style: TextStyle(
                                                color: Colors.white,
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18
                                              ),),
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Text("Gas levels rising, monitor closely", style: TextStyle(
                                                    color: Colors.black,
                                                    fontSize: 14,
                                                  ),),
                                                ],
                                      ...
                                      Row(
                                        ...
                                        Row(
                                          ...
                                          children: [
                                            Column(
                                              children: [
                                                Text("Total Sensors", style: TextStyle(
                                                  color: Colors.white,
                                                  fontSize: 18,
                                                ),),
                                                SizedBox(height: 8,),
...
Widget _buildLevels(double reading){
  return Text(reading.toString()+" ppm",style: TextStyle(
    color: reading<=1.0 ? Colors.green : reading<=1.5? Colors.orange:Colors.red,
    fontSize: 18,
    fontWeight: FontWeight.bold
  ),);
}
